...
export function TopBar({ member }: { member: Member }) {
  return (
    <header className="sticky top-0 z-40 flex h-16 items-center gap-2 border-b border-warm-300 bg-warm-50 px-3 sm:gap-3 sm:px-4 md:gap-6 md:px-6">
      ...
      <div className="surface relative hidden h-9 w-full max-w-[460px] items-center rounded-full pr-3 pl-[38px] text-warm-500 md:flex">
        ...
        <span className="type-body flex-1 truncate">
          Search topics, members, guides, Circles and more
        </span>
